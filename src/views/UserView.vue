<template>
    ...
    <el-form inline="true">
      <el-form-item label="用户id">
        <el-input v-model="params.userId" placeholder="请您输入用户id" />
      </el-form-item>
      <el-form-item label="用户昵称">
        <el-input v-model="params.nickName" placeholder="请您输入用户昵称" />
      </el-form-item>
      <el-form-item>
    ...
    <!-- 表格 -->
    <el-table height="530px" :data="userList">
      <el-table-column prop="userId" label="用户id" width="220px" />
      ...
      <el-table-column prop="phone" width="180px" label="手机号" />
      <el-table-column prop="email" width="220px" label="邮箱" />
      <el-table-column prop="wechat" width="180px" label="微信号" />
      <el-table-column label="学校/专业" width="240px">
        <template #default="{ row }">
          <span class="block-span"> 学校: {{ row.schoolName }}</span>
          <span class="block-span"> 专业: {{ row.majorName }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="introduce" label="个人介绍" width="220"/>
